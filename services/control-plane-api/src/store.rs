...
use metering::{
    ...
    default_catalog, quote_usage_for_catalog, quote_usage_with_additions,
};
use protocol_ir::{
...
impl StoreMode {
    ...
    pub async fn get_pricing_catalog(&self) -> Result<PricingCatalogResponse> {
        match self {
            Self::Memory(_) => Ok(pricing_catalog_response(default_catalog())),
...
impl PostgresStore {
    ...
    pub async fn seed(&self) -> Result<()> {
        ...
        seed_pricing_catalog(&self.pool, &default_catalog()).await?;
...
fn simulate_pricing_with_catalog(
...
fn pricing_catalog_response(catalog: PricingCatalog) -> PricingCatalogResponse {
