...
use protocol_ir::{
    BalanceProjectionResponse, MessageEnvelope, MessageType, RouteReceiptRecorded,
...
use provider_traits::{
    ...
    ProviderMessage, ProviderRequest, ProviderResponse, ProviderTargetKind, TransitGatewayKind,
