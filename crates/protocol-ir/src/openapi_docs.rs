...
#[openapi(
    ...
    paths(
        ...
        prepare_delivery,
        crate::delivery_redemption_openapi::prepare_delivery_redemption_units,
        crate::delivery_redemption_openapi::list_delivery_redemption_inventory,
        get_delivery,
        revoke_delivery,
    ...
    components(
        schemas(
            ...
            DeliveryProjection,
            DeliveryRedemptionInventory,
            DeliveryRedemptionInventoryOwner,
            DeliveryRedemptionInventoryResponse,
            DeliveryRedemptionInventoryUnit,
            DeliveryRedemptionUnit,
            DeliveryRedemptionUnitsBatch,
            DeliveryResponse,
