...
| CTL-004 | Build TanStack Start + HeroUI application shell and authenticated app layout | Control Plane and Console          | FND-002, FND-006 |
...
- Control plane skeleton and TanStack + HeroUI app shell exist.
