...
function formatSessionLabel(
  requestContext: ReturnType<typeof useRequestContext>,
) {
  ...
  const tenantLabel =
    requestContext.session.session.activeTenant?.tenantSlug ?? "platform-admin";
...
function RootProvidersInner() {
  ...
  return (
    <>
      ...
      >
        {formatSessionLabel(requestContext)} • {requestContext.requestId} •{" "}
