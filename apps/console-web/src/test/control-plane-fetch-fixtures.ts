...
export const openingGrantsInitialState = [
  {
  ...
  {
    grant_id: "opengrant_northstar_research_1",
    tenant_id: "tenant_northstar",
    project_id: "proj_ns_research",
    owner_account_id: "acct_ns_owner",
    grantee_kind: "workspace",
    grantee_id: "workspace_research",
    config_snapshot_id: "cfgsnap_gateway_v1",
    route_policy_id: "routepol_northstar_research",
    budget_policy_id: "budgetpol_default",
    provider_resource_ids: ["prvrsrc_openai_research"],
    credential_kind: "api_key",
    credential_id: "cred_opening_northstar_research_1",
    credential_key_prefix: "akp-ns",
    credential_last_four: "ns01",
    scopes: ["route:research"],
    expires_at: "2027-05-22T00:00:00Z",
    status: "active",
    created_by: "user_admin",
    created_at: "2026-04-22T00:00:00Z",
